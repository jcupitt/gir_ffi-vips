...
module Vips
    ...
    class Image
        ...
        #--
        # We'd like to use :include: here, but that doesn't seem to let us
        # document many methods in one file. So we just copy-paste the output of
        # Vipsd::generate_rdoc, with correct indenting. 
        #++
